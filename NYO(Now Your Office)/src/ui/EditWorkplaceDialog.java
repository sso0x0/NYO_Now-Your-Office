...
public class EditWorkplaceDialog extends JDialog {
    ...
    public static class EditWorkplaceFormData {
        private final String companyName, hourlyRateText, dayHoursText, nightHoursText;
        public EditWorkplaceFormData(String c, String r, String d, String n) {
    ...
    public interface OnSaveListener { void onSave(EditWorkplaceFormData formData); }

    private final Frame          parentFrame;
    private final Workplace      oldWorkplace;
    private final OnSaveListener onSaveListener;
    private JTextField companyInput, hourlyRateInput, dayHoursInput, nightHoursInput;

    public EditWorkplaceDialog(Frame parentFrame, Workplace oldWorkplace, OnSaveListener onSaveListener) {
        super(parentFrame, true);
        this.parentFrame = parentFrame; this.oldWorkplace = oldWorkplace; this.onSaveListener = onSaveListener;
    ...
    private void initializeUI() {
        ...
        JLabel titleLbl = new JLabel("근무지 정보 수정");
        ...
        dayHoursInput   = styledField("");
        nightHoursInput = styledField("");
    ...
    private void fillInitialValues() {
        if (oldWorkplace == null) return;
        companyInput.setText(oldWorkplace.getCompanyName());
        hourlyRateInput.setText(String.valueOf(oldWorkplace.getHourlyRate()));
        dayHoursInput.setText(String.valueOf(oldWorkplace.getStandardDayHours()));
        nightHoursInput.setText(String.valueOf(oldWorkplace.getStandardNightHours()));
    }
    ...
    private void handleSave() {
        try {
            ...
            if (onSaveListener != null) onSaveListener.onSave(new EditWorkplaceFormData(c, r, d, n));
            dispose();
